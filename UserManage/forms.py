...
class AddUserForm(forms.ModelForm):
    class Meta:
        model = User
        fields = ('username','password','email','nickname','sex','role','moblie_num','qq_num','is_active')
        widgets = {
	    ...
	    'moblie_num' : forms.TextInput(attrs={'class':'form-control'}),
	...
	self.fields['moblie_num'].label=u'手机号'
	self.fields['moblie_num'].error_messages={'required':u'请输入手机号'}
        self.fields['qq_num'].label=u'QQ号'
	self.fields['qq_num'].error_messages={'required':u'请输入QQ号'}
...
class EditUserForm(forms.ModelForm):
    class Meta:
        model = User
        fields = ('username','email','nickname','sex','role','moblie_num','qq_num','is_active')
        widgets = {
            'username' : forms.TextInput(attrs={'class':'form-control'}),
